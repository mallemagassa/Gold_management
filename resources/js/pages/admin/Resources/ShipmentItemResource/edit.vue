...
function normalizeDates(shipmentItem, formFields) {
...
const form = useForm(
  normalizeDates(props.shipmentItem, props.form)
)

function submitForm() {
  form.put(props.resource.routes.update.replace(':id', props.shipmentItem.id), {
