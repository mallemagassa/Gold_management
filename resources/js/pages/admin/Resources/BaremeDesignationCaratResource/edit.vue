...
function normalizeDates(baremedesignationcarat, formFields) {
  const result = { ...baremedesignationcarat }
...
const form = useForm(
  normalizeDates(props.baremedesignationcarat, props.form)
)

function submitForm() {
  form.put(props.resource.routes.update.replace(':id', props.baremedesignationcarat.id), {
