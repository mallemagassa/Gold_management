    ...
    <div class="flex flex-col gap-6 p-4">
      <div class="flex justify-between items-center">
        ...
        <div class="flex gap-2">
          <Link :href="`${resource.routes.edit.replace(':id', baremedesignationcarat.id)}`">
      ...
      <Card>
        <CardHeader>
          <CardTitle class="flex items-center gap-4">
            <span>  </span>
            <Badge :variant="getStatusBadgeVariant(baremedesignationcarat.is_active)">
        ...
        <CardContent class="grid gap-4 md:grid-cols-2">
          ...
          <div class="space-y-1">
            ...
            <p class="text-sm">{{ formatDate(baremedesignationcarat.created_at) }}</p>
          </div>

          <div class="space-y-1">
            <h3 class="text-sm font-medium text-gray-500">Dernière modification</h3>
            <p class="text-sm">{{ formatDate(baremedesignationcarat.updated_at) }}</p>
          </div>
