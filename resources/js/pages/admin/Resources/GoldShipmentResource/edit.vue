...
function normalizeDates(goldshipment, formFields) {
  const result = { ...goldshipment }
...
const form = useForm(
  normalizeDates(props.goldshipment, props.form)
)

function submitForm() {
  form.put(props.resource.routes.update.replace(':id', props.goldshipment.id), {
