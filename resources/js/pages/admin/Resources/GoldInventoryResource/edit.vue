...
const props = defineProps({
  goldinventory: Object,
  form: Object,
  resource: Object,
})

// 🔁 Normalisation des dates
function normalizeDates(goldinventory, formFields) {
  const result = { ...goldinventory }
...
const form = useForm(
  normalizeDates(props.goldinventory, props.form)
)

function submitForm() {
  form.put(props.resource.routes.update.replace(':id', props.goldinventory.id), {
