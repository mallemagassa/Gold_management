...
function normalizeDates(exchangerate, formFields) {
...
const form = useForm(
  normalizeDates(props.exchangerate, props.form)
)

function submitForm() {
  form.put(props.resource.routes.update.replace(':id', props.exchangerate.id), {
