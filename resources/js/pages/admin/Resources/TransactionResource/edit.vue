...
function normalizeDates(transaction, formFields) {
...
const form = useForm(
  normalizeDates(props.transaction, props.form)
)

function submitForm() {
  form.put(props.resource.routes.update.replace(':id', props.transaction.id), {
