...
interface RefiningBatche {
batch_code: string;
  total_weight_input: string;
  estimated_loss: string;
  refined_weight_output: string;
  refined_purity: string;
  refining_date: string | Date;
...
const props = defineProps({
  table: {
    type: Object as () => {
      ...
      columns: ColumnDef<RefiningBatche>[]
    },
    required: true
  },
  resource: {
