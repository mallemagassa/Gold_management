...
const props = defineProps({
  refiningbatche: Object,
  form: Object,
  resource: Object,
})

// 🔁 Normalisation des dates
function normalizeDates(refiningbatche, formFields) {
  const result = { ...refiningbatche }
...
const form = useForm(
  normalizeDates(props.refiningbatche, props.form)
)

function submitForm() {
  form.put(props.resource.routes.update.replace(':id', props.refiningbatche.id), {
