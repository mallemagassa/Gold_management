...
const props = defineProps({
  goldmarketprice: Object,
  form: Object,
  resource: Object,
})

// 🔁 Normalisation des dates
function normalizeDates(goldmarketprice, formFields) {
...
const form = useForm(
  normalizeDates(props.goldmarketprice, props.form)
)

function submitForm() {
  form.put(props.resource.routes.update.replace(':id', props.goldmarketprice.id), {
